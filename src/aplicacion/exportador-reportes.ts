...
export class ExportadorReportes {
   ...
   */
  async exportarCSV(informe: InformeDiario, rutaSalida: string): Promise<void> {
    // Encabezados
   ...
   * @returns Promesa que se resuelve cuando se guarda
   */
  async exportarJSON(informe: InformeDiario, rutaSalida: string): Promise<void> {
   ...
   * @returns Promesa que se resuelve cuando se guarda
   */
  async exportarHTML(informe: InformeDiario, rutaSalida: string): Promise<void> {
...
`;
   ...
   */
  async validarRutaSalida(ruta: string): Promise<boolean> {
    try {
