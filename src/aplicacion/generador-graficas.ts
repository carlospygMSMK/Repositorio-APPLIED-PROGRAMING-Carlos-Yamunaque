...
export class GeneradorGraficas {
   ...
   */
  async generarJSON(datos: DatosGraficaDias, config: ConfiguracionGrafica): Promise<ResultadoGrafica> {
    try {
   ...
   */
  async generarSVG(datos: DatosGraficaDias, config: ConfiguracionGrafica): Promise<ResultadoGrafica> {
    try {
   ...
   */
  private crearSVG(datos: DatosGraficaDias, config: ConfiguracionGrafica): string {
